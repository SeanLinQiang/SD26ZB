#ifndef __SN32F700B_CT16_H
#define __SN32F700B_CT16_H
...
#define	CT16_MR9IE_EN						1		//[29:29] Enable MR9 match interrupt
#define	CT16_MR9IE_DIS					0
#define mskCT16_MR9IE_EN				(CT16_MR9IE_EN<<29)
#define mskCT16_MR9IE_DIS				(CT16_MR9IE_DIS<<29)

#define	CT16_MR9RST_EN					1		//[30:30] Enable reset TC when MR3 matches TC.
#define	CT16_MR9RST_DIS					0
#define mskCT16_MR9RST_EN				(CT16_MR9RST_EN<<30)
#define mskCT16_MR9RST_DIS			(CT16_MR9RST_DIS<<30)

#define	CT16_MR9STOP_EN					1		//[31:31] Enable stop TC and clear CEN when MR3 matches TC.
#define	CT16_MR9STOP_DIS				0
#define mskCT16_MR9STOP_EN			(CT16_MR9STOP_EN<<31)
#define mskCT16_MR9STOP_DIS			(CT16_MR9STOP_DIS<<31)
...
#define mskCT16_EMC3_DO_NOTHING	(CT16_EMC3_LOW<<10)
#define mskCT16_EMC3_LOW				(CT16_EMC3_LOW<<10)
#define mskCT16_EMC3_HIGH				(CT16_EMC3_HIGH<<10)
#define mskCT16_EMC3_TOGGLE			(CT16_EMC3_TOGGLE<<10)
...
#define mskCT16_PWM3MODE_1			(CT16_PWM3MODE_1<<10)
#define mskCT16_PWM3MODE_2			(CT16_PWM3MODE_2<<10)
#define mskCT16_PWM3MODE_FORCE_0	(CT16_PWM3MODE_FORCE_0<<10)
#define mskCT16_PWM3MODE_FORCE_1	(CT16_PWM3MODE_FORCE_1<<10)
...
#define	CT16_PWM3IOEN_EN				1	// PWM 3 pin acts as match output.
#define	CT16_PWM3IOEN_DIS				0	// PWM 3 pin acts as GPIO.	
#define mskCT16_PWM3IOEN_EN			(CT16_PWM3IOEN_EN<<23)
#define mskCT16_PWM3IOEN_DIS		(CT16_PWM3IOEN_DIS<<23)

																	//[25:24] CT16Bn PWM0N IO selection.
#define	CT16_PWM0N_GPIO					0	// PWM0N pin acts as GPIO
#define	CT16_PWM0N_MODE1				1 // PWM0N pin outputs the inverse signal with dead-band of PWM0, but same High signal during dead-band period.
#define	CT16_PWM0N_MODE2				2 // PWM0N pin outputs the inverse signal with dead-band of PWM0, but same Low signal during dead-band period.
#define	CT16_PWM0N_MODE3				3 // PWM0N pin outputs the same signal with dead-band of PWM0.
#define mskCT16_PWM0N_GPIO			(CT16_PWM0N_GPIO<<24)
#define mskCT16_PWM0N_MODE1			(CT16_PWM0N_MODE1<<24)
#define mskCT16_PWM0N_MODE2			(CT16_PWM0N_MODE2<<24)
#define mskCT16_PWM0N_MODE3			(CT16_PWM0N_MODE3<<24)

																	//[27:26] CT16Bn PWM1N IO selection.
#define	CT16_PWM1N_GPIO					0	// PWM1N pin acts as GPIO
#define	CT16_PWM1N_MODE1				1 // PWM1N pin outputs the inverse signal with dead-band of PWM1, but same High signal during dead-band period.
#define	CT16_PWM1N_MODE2				2 // PWM1N pin outputs the inverse signal with dead-band of PWM1, but same Low signal during dead-band period.
#define	CT16_PWM1N_MODE3				3 // PWM1N pin outputs the same signal with dead-band of PWM1.
#define mskCT16_PWM1N_GPIO			(CT16_PWM1N_GPIO<<26)
#define mskCT16_PWM1N_MODE1			(CT16_PWM1N_MODE1<<26)
#define mskCT16_PWM1N_MODE2			(CT16_PWM1N_MODE2<<26)
#define mskCT16_PWM1N_MODE3			(CT16_PWM1N_MODE3<<26)

																	//[29:28] CT16Bn PWM2N IO selection.
#define	CT16_PWM2N_GPIO					0	// PWM2N pin acts as GPIO
#define	CT16_PWM2N_MODE1				1 // PWM2N pin outputs the inverse signal with dead-band of PWM2, but same High signal during dead-band period.
#define	CT16_PWM2N_MODE2				2 // PWM2N pin outputs the inverse signal with dead-band of PWM2, but same Low signal during dead-band period.
#define	CT16_PWM2N_MODE3				3 // PWM2N pin outputs the same signal with dead-band of PWM2.
#define mskCT16_PWM2N_GPIO			(CT16_PWM0N_GPIO<<28)
#define mskCT16_PWM2N_MODE1			(CT16_PWM0N_MODE1<<28)
#define mskCT16_PWM2N_MODE2			(CT16_PWM0N_MODE2<<28)
#define mskCT16_PWM2N_MODE3			(CT16_PWM0N_MODE3<<28)

																	//[31:30] CT16Bn PWM3N IO selection.
#define	CT16_PWM3N_GPIO					0	// PWM3N pin acts as GPIO
#define	CT16_PWM3N_MODE1				1 // PWM3N pin outputs the inverse signal with dead-band of PWM3, but same High signal during dead-band period.
#define	CT16_PWM3N_MODE2				2 // PWM3N pin outputs the inverse signal with dead-band of PWM3, but same Low signal during dead-band period.
#define	CT16_PWM3N_MODE3				3 // PWM3N pin outputs the same signal with dead-band of PWM3.
#define mskCT16_PWM3N_GPIO			(CT16_PWM3N_GPIO<<30)
#define mskCT16_PWM3N_MODE1			(CT16_PWM3N_MODE1<<30)
#define mskCT16_PWM3N_MODE2			(CT16_PWM3N_MODE2<<30)
#define mskCT16_PWM3N_MODE3			(CT16_PWM3N_MODE3<<30)
